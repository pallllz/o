...
global.danano = "-"
global.shopeepayno = "-"
global.creator = "6288975317165@s.whatsapp.net"
global.thumb = fs.readFileSync(`./image/thumb.png`)
global.qrisdonate = fs.readFileSync(`./image/qris.jpg`)
global.fake = `📍𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝑩𝒚 𝑲𝒂𝒚𝒍𝒂 𝑩𝒐𝒕 𝑾𝒉𝒂𝒕𝒔𝑨𝒑𝒑`
global.packname = ``
global.author = `×͜× ▭▬▭▬▭▬ 👑 ▭▬▭▬▭▬ ×͜×\nﾒ 𝗖𝗿𝗲𝗮𝘁𝗲𝗱 Pals\nﾒ 𝗖𝗿𝗲𝗮𝘁𝗼𝗿 palz : 𝟬𝟴𝟳𝟳𝟬𝟱𝟬𝟰𝟴𝟮𝟯𝟱\nﾒ 𝗬𝗼𝘂𝘁𝘂𝗯𝗲 : 𝗞𝗶𝗿𝗕𝗼𝘁𝘇\n⊟————————⊟`
global.antilink = false
global.antiwame = false
global.autodltt = false
global.autosticker = false
global.ownerNomor = '6281348106274'
global.ownerName = 'A17-MD'
global.ownerNumber = ["6281348106274@s.whatsapp.net"]
